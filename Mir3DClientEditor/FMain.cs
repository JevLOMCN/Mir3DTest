...
namespace Mir3DClientEditor
{
    ...
    {
        global::System.String _smokeTestString = "";
        global::System.Collections.Generic.List<int> _smokeTestList = new global::System.Collections.Generic.List<int>();
        ...
        private void Menu_OpenFile_Click(object sender, EventArgs e)
        {
            ...
            {
                Filter = "All Mir3D Files|*.pak;*.txt;*.ini;*.int;*.upk;*.umap;*.udk;*.u|Mir3D txt file|*.txt|Mir3D ini file|*.ini|Mir3D int file|*.int|Mir3D UPK file|*.upk|Mir3D UMAP file|*.umap|Mir3D UDK|*.udk|Mir3D U File|*.u|Mir3D Pak File|*.pak",
        ...
        private void ShowSelectedPath(string path)
        {
            FilePathTextBox.Text = path ?? string.Empty;
        ...
        private void Menu_File_OpenGameFolder_Click(object sender, EventArgs e)
        {
            ...
            MainEditor.LoadGameFolder(selectedPath);
        }
        ...
        private void FMain_Load(object sender, EventArgs e)
        {
            ...
            using (var splash = new FSplash())
            {
                splash.ShowDialog(this);

                if (splash.NoShowAgain)
                {
